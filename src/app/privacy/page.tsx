  ...
  return (
    <div className="bg-gray-100 text-black">
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="mb-4">
          This privacy policy sets out how our MonthlyBudget website uses and
          protects any information that you give us when you use this
          MonthlyBudget website.
        </p>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            ...
            mail. We may use the information to customize the MonthlyBudget
        ...
        <p className="mb-4">
          Overall, cookies help us provide you with a better MonthlyBudget
        ...
        <h2 className="text-2xl font-bold mb-2">
          Links to Other MonthlyBudget websites
        </h2>

        <p className="mb-4">
          Our MonthlyBudget website may contain links to other MonthlyBudget
          ...
          other MonthlyBudget website. Therefore, we cannot be responsible for
          ...
          statement applicable to the MonthlyBudget website in question.
        </p>
        ...
        <ul className="list-disc list-inside mb-4">
          <li>
            ...
            by writing to or emailing us at acounts@monthlybudget.com
          </li>
          <li>
          ...
          <li>
            ...
            email acounts@monthlybudget.com
          </li>
          <li>
