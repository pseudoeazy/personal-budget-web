...
const Faq = () => {
  return (
    <section className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px] px-8">
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div
            className={`wow fadeInUp w-full px-4 ${'mx-auto text-center'}`}
            data-wow-delay=".1s"
            style={{ maxWidth: '640px' }}
          >
            <span className="mb-2 block text-lg font-semibold text-background">
              FAQ
            </span>

            <h2 className="mb-4 text-3xl font-bold text-background sm:text-4xl md:text-[40px] md:leading-[1.2]">
